...
public class Reachability {
    ...
    @available(*, deprecated, message: "allowsCellularConnection")
    ...
    @available(*, deprecated, message: "connection.description")
    public var currentReachabilityString: String {
        return "\(connection)"
    }
    
    @available(*, deprecated, message: "connection")
    ...
    fileprivate let reachabilitySerialQueue = DispatchQueue(label: "com.hungama.reachability")
